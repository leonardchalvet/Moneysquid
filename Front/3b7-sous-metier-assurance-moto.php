...
<html>
	<head>
		...
		<title>3b7 - Sous Métier - Assurance Moto</title>
		...
		<main>
			...
			<section class="section-cover">
				<div class="wrapper">
					...
					<h1>Assurance <em>moto</em></h1>
					<p class="desc">Économisez jusqu’à 45% sur votre assurance moto !</p>
					...
					<img class="illu-1" src="img/common-section_cover:sousmetier/illu-11.svg" alt="">
				</div>
			</section>
			...
			<section class="section-compare">
				<div class="wrapper">
					<h2>Pourquoi comparer les assurances moto ?</h2>
					<div class="container-el">
						<div class="el">
							<div class="icn">
			...
			<section class="section-simulation style-onlybanner">
				<div class="wrapper">
					<div class="banner">
						<h3>Économisez jusqu’à<br><em>45% sur votre contrat*</em></h3>
						<div class="container-btn">
							<a href="" class="btn">
								<span class="btn-text">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur l'assurance moto</h2>
					<div class="container">
						<div class="container-tab">
							<div class="tab">
								...
								<h3>Guide sur<br>l'assurance moto</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>FAQ sur<br> l'assurance moto</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lettre type sur<br>l'assurance moto</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lexique sur<br>l'assurance moto</h3>
								<div class="cross"></div>
							</div>
						</div>
			...
			<section class="common-section_actu">
				<div class="wrapper">
					<h2>
						<a href="#">Les actualités de l’assurance moto</a>
					</h2>
					<div class="container-el">
						<div class="el">
			...
			<section class="common-section_autremetiers">
				<div class="wrapper">
					<h2>L’essentiel de l’assurance moto</h2>
					<div class="container-section">
						<div class="section">
							<div class="icn">
								<img src="img/common-section_autremetiers/icn-13.svg" alt="">
							</div>
							<div class="text">
								<div class="title">
			...
			<section class="common-section_faq">
				...
				<div class="wrapper">
					<h2>Les réponses à vos questions sur l’assurance moto</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">

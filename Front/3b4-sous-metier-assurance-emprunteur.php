		...
		<main>
			...
			<section class="section-cover">
				<div class="wrapper">
					...
					<img class="illu-1" src="img/common-section_cover:sousmetier/illu-8.svg" alt="">
				</div>
			</section>
			...
			<section class="section-simulation style-onlybanner">
				<div class="wrapper">
					<div class="banner">
						<h3>Économisez<br><em>jusqu’à 33%*</em></h3>
						<div class="container-btn">
							<a href="" class="btn">
								<span class="btn-text">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur l’assurance emprunteur</h2>
					<div class="container">
						<div class="container-tab">
							<div class="tab">
								...
								<h3>Guide sur l'assurance<br>emprunteur</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>FAQ sur l'assurance<br>emprunteur</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lettre type sur<br>l'assurance emprunteur</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lexique sur<br>l'assurance emprunteur</h3>
								<div class="cross"></div>
							</div>
						</div>
			...
			<section class="common-section_actu">
				<div class="wrapper">
					<h2>
						<a href="#">Les actualités de l’assurance emprunteur</a>
					</h2>
					<div class="container-el">
						<div class="el">
			...
			<section class="common-section_autremetiers">
				<div class="wrapper">
					<h2>L’essentiel de l’assurance emprunteur</h2>
			...
			<section class="common-section_faq">
				...
				<div class="wrapper">
					<h2>Les réponses à vos questions sur l’assurance emprunteur</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">

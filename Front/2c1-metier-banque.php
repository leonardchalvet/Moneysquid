	...
	<body>
		...
		<main>
			...
			<section class="common-section_compare">
				<div class="wrapper">
					<div class="container-el">
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-10.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
						...
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-9.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
										Banque <br/>professionnel
									</a>
								</h3>
								<p class="text-1">
									À partir de
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur la banque</h2>
					<div class="container">
						<div class="container-tab">
							...
							<div class="tab">
								...
								<h3>FAQ<br>sur la banque</h3>
							</div>
							<div class="tab">
								<div class="icn">
									<img src="img/sousmetier/section-knoweverything/icn-1.svg" alt="">
								</div>
								<h3>Lettre type<br>sur la banque</h3>
							</div>
							<div class="tab">
								<div class="icn">
									<img src="img/sousmetier/section-knoweverything/icn-1.svg" alt="">
								</div>
								<h3>Lexique<br>sur la banque</h3>
							</div>
						</div>
							...
							<div class="container-el">
								<div class="el">
							        <div class="content">
										...
										<div class="text">
											<h3><a href="#">Banque en ligne compte perso</a></h3>
											<p>
								...
								<div class="el">
							        <div class="content">
										...
										<div class="text">
											<h3><a href="#">Banque en ligne professionnel</a></h3>
											<p>
												Courtier en crédit immobilier, Bourse des Crédits peut vous accompagner pour l’obtention de votre financement immobilier.  En véritable expert, nous pouvons comparer les banques en prêt immobilier qui opèrent en France, afin de vous obtenir le meilleur taux et les conditions de crédits les plus avantageuses.<br><br>
												Reconnue parmi les entreprises les plus innovantes de son secteur, Bourse des Crédits vous accompagne également dans la négociation de votre emprunt immobilier.<br><br>
												Nos outils de simulation et comparaison de crédit, vous permettend d’avoir accès aux meilleurs taux de prêts du marché et de faire votre demande de crédit en ligne qui sera relayée à tous nos partenaires organismes de crédit.
			...
			<section class="common-section_faq">
				...
				<img class="path-2" src="img/common-section_cover:metiers/path-2.svg" alt="">
				<div class="wrapper">
					<h2>Les réponses à toutes vos questions sur la banque</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">
		...
		<script type="text/javascript" src="script/minify/js-common-page_metiers-min.js"></script>
	</body>
</html>
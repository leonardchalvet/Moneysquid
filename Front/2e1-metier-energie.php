...
<html>
	<head>
		...
		<title>2e1 - Métier Énergie</title>
	...
	<body>
		...
		<main>
			...
			<section class="common-section_compare">
				<div class="wrapper">
					<div class="container-el">
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-13.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
						...
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-14.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur les fournisseurs d'énergie</h2>
					<div class="container">
						<div class="container-tab">
							...
							<div class="tab">
								...
								<h3>FAQ sur les<br>fournisseurs d'énergie</h3>
							</div>
							<div class="tab">
								<div class="icn">
									<img src="img/sousmetier/section-knoweverything/icn-1.svg" alt="">
								</div>
								<h3>Lettre type sur les<br>fournisseurs d'énergie</h3>
							</div>
							<div class="tab">
								<div class="icn">
									<img src="img/sousmetier/section-knoweverything/icn-1.svg" alt="">
								</div>
								<h3>Lexique sur les<br>fournisseurs d'énergie</h3>
							</div>
						</div>
			...
			<section class="common-section_faq">
				...
				<img class="path-2" src="img/common-section_cover:metiers/path-2.svg" alt="">
				<div class="wrapper">
					<h2>Les réponses à toutes vos questions sur l'énergie</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">

		...
		<main>
			...
			<section class="section-cover">
				<div class="wrapper">
					...
					<h1>Crédit <em>professionnel</em></h1>
					<p class="desc">Comparez et obtenez le meilleur taux professionnel</p>
			...
			<section class="section-howitwork">
				<div class="wrapper">
					...
					<div class="container-el">
						...
						<div class="el">
							<div class="icn">
								<img src="img/sousmetier/section-howitwork/icn-2.svg" alt="">
							</div>
							<p>
								Vous obtenez une réponse immédiate
							</p>
						</div>
						<div class="el">
							<div class="icn">
								<img src="img/sousmetier/section-howitwork/icn-3.svg" alt="">
							</div>
							<p>
								Un expert vous conseille et vous optimise votre plan de financement
							</p>
						</div>
						<div class="el">
							<div class="icn">
							...
							<p>
								Vous avez trouvé la meilleure offre pour votre crédit
							</p>
						</div>
					</div>
				</div>
			...
			<section class="section-compare">
				<div class="wrapper">
					<h2>Pourquoi comparer les taux de prêt immobilier ? </h2>
					<div class="container-el">
						<div class="el">
							<div class="icn">
				...
				<div class="wrapper">
					...
					<div class="container-el">
						...
						<div class="el">
							...
							<p>
								Tableau<br>d’amortissement
							</p>
						</div>
						<div class="el">
							<div class="icn">
								<img src="img/sousmetier/section-simulation/icn-6.svg" alt="">
							</div>
							<p>
								Calculer son<br>endettement
							</p>
						</div>
					</div>
					<div class="banner">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur le prêt professionnel</h2>
					<div class="container">
						<div class="container-tab">
							<div class="tab">
								...
								<h3>Guide<br>prêt professionnel</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>FAQ du<br>prêt professionnel</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lettre type du<br>prêt professionnel</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lexique du<br>prêt professionnel</h3>
								<div class="cross"></div>
							</div>
						</div>
			...
			<section class="common-section_actu">
				<div class="wrapper">
					<h2>
						<a href="#">Les actualités du prêt professionnel</a>
					</h2>
					<div class="container-el">
						<div class="el">

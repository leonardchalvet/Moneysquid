...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="style/css/style-page_guide_sous_metier.css">
				...
				<div class="wrapper">
					<div class="container-el">
						<div class="el">
							<div class="head">
								<div class="icn">
									<img src="img/5b1-guide_sous_metier/section-ftr/icn-1.svg" alt="">
								</div>
								<h2>
									Crédit auto
								</h2>
							...
							<div class="container-list">
								<div class="list">
									<div class="title">
										<h3>Frais de dossier négocier par MoneySquid</h3>

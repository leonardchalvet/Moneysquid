...
<html>
	<head>
		...
		<title>2d1 - Métier Patrimoine</title>
	...
	<body>
		...
		<main>
			...
			<section class="common-section_compare">
				<div class="wrapper">
					<div class="container-el">
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-11.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
						...
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-17.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
						...
						<div class="el">
							<div class="icn">
								<img src="img/common-section_compare/illu-12.svg" alt="">
							</div>
							<div class="text">
								<h3>
									<a class="title" href="#">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur le patrimoine</h2>
					<div class="container">
						<div class="container-tab">
							...
							<div class="tab">
								...
								<h3>FAQ<br>sur le patrimoine</h3>
							</div>
							<div class="tab">
								<div class="icn">
									<img src="img/sousmetier/section-knoweverything/icn-1.svg" alt="">
								</div>
								<h3>Lettre type<br>sur le patrimoine</h3>
							</div>
							<div class="tab">
								<div class="icn">
									<img src="img/sousmetier/section-knoweverything/icn-1.svg" alt="">
								</div>
								<h3>Lexique<br>sur le patrimoine</h3>
							</div>
						</div>
			...
			<section class="common-section_faq">
				...
				<img class="path-2" src="img/common-section_cover:metiers/path-2.svg" alt="">
				<div class="wrapper">
					<h2>Les réponses à toutes vos questions sur le patrimoine</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">

...
<html>
	<head>
		...
		<title>3b12 - Sous Métier - Mutuelle Santé</title>
		...
		<main>
			...
			<section class="section-cover">
				<div class="wrapper">
					...
					<h1>Mutuelle <em>santé</em></h1>
					<p class="desc">À partir de 5,92€/mois*</p>
					...
					<img class="illu-1" src="img/common-section_cover:sousmetier/illu-16.svg" alt="">
				</div>
			</section>
			...
			<section class="section-compare">
				<div class="wrapper">
					<h2>Pourquoi comparer les mutuelles santé ?</h2>
					<div class="container-el">
						<div class="el">
							<div class="icn">
			...
			<section class="section-simulation style-onlybanner">
				<div class="wrapper">
					<div class="banner">
						<h3>À partir de<br><em>5,92€/mois*</em></h3>
						<div class="container-btn">
							<a href="" class="btn">
								<span class="btn-text">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur la mutuelle santé</h2>
					<div class="container">
						<div class="container-tab">
							...
							<div class="tab">
								...
								<h3>Lettre type<br>mutuelle santé</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lexique<br>mutuelle santé</h3>
								<div class="cross"></div>
							</div>
						</div>
			...
			<section class="common-section_actu">
				<div class="wrapper">
					<h2>
						<a href="#">Les actualités de la mutuelle santé</a>
					</h2>
					<div class="container-el">
						<div class="el">
			...
			<section class="common-section_autremetiers">
				<div class="wrapper">
					<h2>L’essentiel de la mutuelle santé</h2>
					<div class="container-section">
						<div class="section">
							<div class="icn">
								<img src="img/common-section_autremetiers/icn-25.svg" alt="">
							</div>
							<div class="text">
								<div class="title">
			...
			<section class="common-section_faq">
				...
				<div class="wrapper">
					<h2>Les réponses à vos questions sur les mutuelles santé</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">

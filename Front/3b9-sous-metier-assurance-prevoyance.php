...
<html>
	<head>
		...
		<title>3b9 - Sous Métier - Assurance Prévoyance</title>
		...
		<main>
			...
			<section class="section-cover">
				<div class="wrapper">
					...
					<h1>Assurance <em>prévoyance</em></h1>
					...
					<nav>
						<ul>
							...
							<li>
								<a href="">
									<span class="link-text">
										Assurance Prévoyance Maintien Soclaire
									</span>
									<svg class="link-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 10">
										<use xlink:href="img/common/icn-arrow-2.svg#content"></use>
									</svg>
					...
					<img class="illu-1" src="img/common-section_cover:sousmetier/illu-13.svg" alt="">
				</div>
			</section>
			...
			<section class="section-compare">
				<div class="wrapper">
					<h2>Pourquoi comparer les assurances prévoyance ?</h2>
					<div class="container-el">
						<div class="el">
							<div class="icn">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur l'assurance prévoyance</h2>
					<div class="container">
						<div class="container-tab">
							<div class="tab">
								...
								<h3>Guide sur<br>l'assurance prévoyance</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>FAQ sur<br> l'assurance prévoyance</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lettre type sur<br>l'assurance prévoyance</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lexique sur<br>l'assurance prévoyance</h3>
								<div class="cross"></div>
							</div>
						</div>
			...
			<section class="common-section_actu">
				<div class="wrapper">
					<h2>
						<a href="#">Les actualités de l’assurance prévoyance</a>
					</h2>
					<div class="container-el">
						<div class="el">
			...
			<section class="common-section_autremetiers">
				<div class="wrapper">
					<h2>L’essentiel de l’assurance prévoyance</h2>
					<div class="container-section">
						<div class="section">
							<div class="icn">
								<img src="img/common-section_autremetiers/icn-15.svg" alt="">
							</div>
							<div class="text">
								<div class="title">
			...
			<section class="common-section_faq">
				...
				<div class="wrapper">
					<h2>Les réponses à vos questions sur l’assurance prévoyance</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">

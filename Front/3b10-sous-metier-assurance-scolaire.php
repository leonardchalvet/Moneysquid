...
<html>
	<head>
		...
		<title>3b10 - Sous Métier - Assurance Scolaire</title>
		...
		<main>
			...
			<section class="section-cover">
				<div class="wrapper">
					...
					<h1>Assurance <em>scolaire</em></h1>
					...
					<img class="illu-1" src="img/common-section_cover:sousmetier/illu-14.svg" alt="">
				</div>
			</section>
			...
			<section class="section-compare">
				<div class="wrapper">
					<h2>Pourquoi comparer les assurances scolaire ?</h2>
					<div class="container-el">
						<div class="el">
							<div class="icn">
			...
			<section class="common-section_knoweverything">
				<div class="wrapper">
					<h2>Tout savoir sur l'assurance scolaire</h2>
					<div class="container">
						<div class="container-tab">
							<div class="tab">
								...
								<h3>Guide sur<br>l'assurance scolaire</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>FAQ sur<br> l'assurance scolaire</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lettre type sur<br>l'assurance scolaire</h3>
								<div class="cross"></div>
							</div>
							<div class="tab">
								<div class="icn">
								...
								<h3>Lexique sur<br>l'assurance scolaire</h3>
								<div class="cross"></div>
							</div>
						</div>
			...
			<section class="common-section_actu">
				<div class="wrapper">
					<h2>
						<a href="#">Les actualités de l’assurance scolaire</a>
					</h2>
					<div class="container-el">
						<div class="el">
			...
			<section class="common-section_autremetiers">
				<div class="wrapper">
					<h2>L’essentiel de l’assurance scolaire</h2>
					<div class="container-section">
						<div class="section">
							<div class="icn">
								<img src="img/common-section_autremetiers/icn-16.svg" alt="">
							</div>
							<div class="text">
								<div class="title">
									<h3>Assurance scolaire</h3>
			...
			<section class="common-section_faq">
				...
				<div class="wrapper">
					<h2>Les réponses à vos questions sur l’assurance scolaire</h2>
					<div class="container-el">
						<div class="el">
							<div class="row">
								<div class="question">
